...
import static net.netcoding.niftycore.util.gson.internal.$Gson$Preconditions.checkArgument;
import static net.netcoding.niftycore.util.gson.internal.$Gson$Preconditions.checkNotNull;
...
public final class $Gson$Types {
	...
	ParameterizedType, Serializable {
		...
		public int hashCode() {
			return Arrays.hashCode(this.typeArguments)
					^ this.rawType.hashCode() ^ hashCodeOrZero(this.ownerType);
		}

		@Override
		public String toString() {
			StringBuilder stringBuilder = new StringBuilder(
					30 * (this.typeArguments.length + 1));
			...
			stringBuilder.append("<").append(
					typeToString(this.typeArguments[0]));
			for (int i = 1; i < this.typeArguments.length; i++)
				stringBuilder.append(", ").append(
						typeToString(this.typeArguments[i]));
	...
	Serializable {
		...
		public Type[] getLowerBounds() {
			return this.lowerBound != null ? new Type[] { this.lowerBound }
			: EMPTY_TYPE_ARRAY;
		}
		...
		public int hashCode() {
			...
			return (this.lowerBound != null ? 31 + this.lowerBound.hashCode()
					: 1) ^ (31 + this.upperBound.hashCode());
		}
