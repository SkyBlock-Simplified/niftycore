...
import net.netcoding.niftycore.util.gson.internal.LazilyParsedNumber;
...
public final class JsonPrimitive extends JsonElement {
	...
	public boolean equals(Object obj) {
		...
		if (isIntegral(this) && isIntegral(other))
			return this.getAsNumber().longValue() == other.getAsNumber()
					.longValue();
	...
	public BigDecimal getAsBigDecimal() {
		return this.value instanceof BigDecimal ? (BigDecimal) this.value
	...
	public BigInteger getAsBigInteger() {
		return this.value instanceof BigInteger ? (BigInteger) this.value
	...
	public byte getAsByte() {
		return this.isNumber() ? this.getAsNumber().byteValue() : Byte
				.parseByte(this.getAsString());
	}
	...
	public double getAsDouble() {
		return this.isNumber() ? this.getAsNumber().doubleValue() : Double
	...
	public float getAsFloat() {
		return this.isNumber() ? this.getAsNumber().floatValue() : Float
	...
	@Override
	public int getAsInt() {
		return this.isNumber() ? this.getAsNumber().intValue() : Integer
	...
	public long getAsLong() {
		return this.isNumber() ? this.getAsNumber().longValue() : Long
	...
	public Number getAsNumber() {
		return this.value instanceof String ? new LazilyParsedNumber(
				(String) this.value) : (Number) this.value;
	}
	...
	public short getAsShort() {
		return this.isNumber() ? this.getAsNumber().shortValue() : Short
				.parseShort(this.getAsString());
	}
	...
	public int hashCode() {
		...
		if (this.value instanceof Number) {
			long value = Double.doubleToLongBits(this.getAsNumber()
					.doubleValue());
			return (int) (value ^ (value >>> 32));
		}
