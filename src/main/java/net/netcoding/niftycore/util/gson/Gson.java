...
package net.netcoding.niftycore.util.gson;
...
import net.netcoding.niftycore.util.gson.internal.ConstructorConstructor;
import net.netcoding.niftycore.util.gson.internal.Excluder;
import net.netcoding.niftycore.util.gson.internal.Primitives;
import net.netcoding.niftycore.util.gson.internal.Streams;
import net.netcoding.niftycore.util.gson.internal.bind.ArrayTypeAdapter;
import net.netcoding.niftycore.util.gson.internal.bind.CollectionTypeAdapterFactory;
import net.netcoding.niftycore.util.gson.internal.bind.DateTypeAdapter;
import net.netcoding.niftycore.util.gson.internal.bind.JsonAdapterAnnotationTypeAdapterFactory;
import net.netcoding.niftycore.util.gson.internal.bind.JsonTreeReader;
import net.netcoding.niftycore.util.gson.internal.bind.JsonTreeWriter;
import net.netcoding.niftycore.util.gson.internal.bind.MapTypeAdapterFactory;
import net.netcoding.niftycore.util.gson.internal.bind.ObjectTypeAdapter;
import net.netcoding.niftycore.util.gson.internal.bind.ReflectiveTypeAdapterFactory;
import net.netcoding.niftycore.util.gson.internal.bind.SqlDateTypeAdapter;
import net.netcoding.niftycore.util.gson.internal.bind.TimeTypeAdapter;
import net.netcoding.niftycore.util.gson.internal.bind.TypeAdapters;
import net.netcoding.niftycore.util.gson.reflect.TypeToken;
import net.netcoding.niftycore.util.gson.stream.JsonReader;
import net.netcoding.niftycore.util.gson.stream.JsonToken;
import net.netcoding.niftycore.util.gson.stream.JsonWriter;
import net.netcoding.niftycore.util.gson.stream.MalformedJsonException;
...
public final class Gson {
	...
	public <T> T fromJson(String json, Type typeOfT) throws JsonSyntaxException {
		...
		T target = (T) this.fromJson(reader, typeOfT);
		return target;
	}
	...
	public void toJson(JsonElement jsonElement, Appendable writer)
			throws JsonIOException {
		try {
			JsonWriter jsonWriter = this.newJsonWriter(Streams
	...
	public String toString() {
		return new StringBuilder("{serializeNulls:")
				.append(this.serializeNulls).append("factories:")
				.append(this.factories).append(",instanceCreators:")
				.append(this.constructorConstructor).append("}").toString();
	}
}
