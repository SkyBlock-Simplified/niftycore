...
public class Oracle extends SQLWrapper {

	public static final int DEFAULT_PORT = 1571;

	public Oracle(String host, String user, String pass, String schema) throws SQLException {
		this(host, DEFAULT_PORT, user, pass, schema);
	}

	public Oracle(String host, int port, String user, String pass, String schema) throws SQLException {
